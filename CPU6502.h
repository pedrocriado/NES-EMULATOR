...
uint8_t ZPY(CPU6502* cpu);  uint8_t IZX(CPU6502* cpu);  
uint8_t IZY(CPU6502* cpu);	uint8_t ABS(CPU6502* cpu);	
uint8_t ABX(CPU6502* cpu);	uint8_t ABY(CPU6502* cpu);  
uint8_t IND(CPU6502* cpu);  uint8_t REL(CPU6502* cpu);	